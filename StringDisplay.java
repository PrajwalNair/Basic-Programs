...
class StringDisplay
{
	public static void main (String [] args)
	{
		...
		String st2 = new String(bytes,Charset.forName("UTF-8"));
		System.out.println(st2);
		String st3 = new String(bytes, 1, 3);
		System.out.println(st3);
		String st4 = new String(bytes,1, 2,Charset.forName("ASCII"));
		System.out.println(st4);
		String st5 = new String(bytes,2,1,Charset.forName("ASCII"));
		System.out.println(st5);
		String st6 = new String(bytes,Charset.forName("ASCII"));
